...
// export const getPopoverAnywhere = (textbox : HTMLElement, promptText : string, parentElement : HTMLElement) => {
//   // Popover element

//   var targetRect = parentElement.getBoundingClientRect();
//   const popover = document.createElement("div");
//   console.log("width of parent element: ", parentElement.style.width, parentElement.style.height)
//   // popover.style.width = targetRect.width + "px";
//   console.log(targetRect.width + "px")
//   popover.style.width = targetRect.width + "px";
...
//   popover.style.bottom = targetRect.top + targetRect.height + 100 + "px";

//   console.log("location of popover: ", )
...
//   //       let temp = "temp"
//   //       if (temp != prompt.replaceAll("<b>", "").replaceAll("</b>", "")) {
